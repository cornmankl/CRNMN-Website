  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-cream': 'linear-gradient(135deg, #FEF9C3 0%, #EAB308 100%)',
        'gradient-sunset': 'linear-gradient(135deg, #FB923C 0%, #F59E0B 50%, #D97706 100%)',
      },
    },
  },
  plugins: [
